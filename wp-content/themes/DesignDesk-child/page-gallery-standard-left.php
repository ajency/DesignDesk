 ...
 */
/*
Template Name: sidebar Gallery - Standard
*/
?>
<?php get_header(); ?>
	...
	?>
		...
		<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
			...
			<div class="row row-special" id="standard-gallery-wrapper">
				...
				<div class="standard-gallery-filter col-2 clearfix">
				...
				<div id="standard-gallery-masonry" class="col-10" data-column-size="col-<?php echo 12/$gallery_columns_count; ?>">
				...
				<div class="col-12 no-b-margin clear">
